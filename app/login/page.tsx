  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-50 px-4 py-8 sm:px-6 md:py-12">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-md items-center">
        <section className="w-full rounded-2xl border border-gray-200 bg-white p-6 shadow-lg transition-all duration-200 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-xl bg-gray-900 px-4 py-2.5 text-sm font-semibold text-white transition duration-200 hover:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-70"
            >
